<template>
    <CommPanel title="穿梭道路" class="point-panel-box">
        <div class="point-panel">
            ...
            <CommButton @click="primitive.show = false" contentClass="clear">隐藏</CommButton>
        </div>
    </CommPanel>
</template>
...
onMounted(() => {
    ...
    viewer.camera.flyTo({
        destination: new Cesium.Cartesian3(-2822634.9300073525, 4823976.31096414, 3739262.3350110534),
        orientation: new Cesium.HeadingPitchRoll(6.215004476693308, -0.9321495455280289, 0.0000013863075700726313),
    })
});
</script>
