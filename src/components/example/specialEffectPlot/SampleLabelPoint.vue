<template>
    <CommPanel title="样本面板点" class="point-panel-box">
...
import sampleLabelPoint from "@/secdev/specialEffectPlot/domPoint/sampleLabelPoint";

let point: sampleLabelPoint;
