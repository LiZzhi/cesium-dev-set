 ...
 * @LastEditTime: 2023-09-21 14:14:34
 * @FilePath: \cesium-secdev-set\src\secdev\spatialAnalysis\maskLayer.ts
 * @Description: 反选遮罩
 */
import { Viewer, PolygonHierarchy } from "cesium";
...
export default class {
    ...
    init(mask: PolygonHierarchy[]) {
        let [p1, p2] = this.globalMaskPosition;
        let h1 = new Cesium.PolygonHierarchy(p1, mask);
    ...
    get globalMaskPosition() {
        return[
            [
                new Cesium.Cartesian3(3197104.586923899, 0.5580000157243585, 5500477.1339386385),
                new Cesium.Cartesian3(3197104.586923899, 0.5580000157243585, -5500477.1339386385),
                new Cesium.Cartesian3(-3197104.5869239476, 3.915323898915733, -5500477.1339386385),
                new Cesium.Cartesian3(-3197104.5869239476, 3.915323898915733, 5500477.1339386385),
            ],
            [
                new Cesium.Cartesian3(3197104.586923899, -0.5580000157243585, 5500477.1339386385),
