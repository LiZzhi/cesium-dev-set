...
const menu:menuConfigType[] = [
    {
        ...
        components: [
            ...
            },
            {
                label: "单个云层",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/singleCloud.jpg"),
                route: "singleCloud",
            ...
            },
            {
                label: "动态墙体",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/dynamicWall.jpg"),
                route: "dynamicWall",
            ...
            },
            {
                label: "动态标记",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/dynamicMarking.jpg"),
            ...
            },
            {
                label: "静态标记",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/staticMarking.jpg"),
                route: "staticMarking",
            ...
            },
            {
                label: "圆柱标记",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/cylinderMarking.jpg"),
            ...
            },
            {
                label: "动态渐变圆",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/dynamicGradientCircle.jpg"),
            ...
            },
            {
                label: "光晕扩散圆",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/haloCircle.jpg"),
                route: "haloCircle",
            ...
            },
            {
                label: "渐变墙体",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/gradientWall.jpg"),
                route: "gradientWall",
            ...
            },
            {
                label: "动态遮罩",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/dynamicMaskPolygon.jpg"),
            ...
            },
            {
                label: "棱柱体",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/boundingBox.jpg"),
                route: "boundingBox",
            ...
            },
            {
                label: "雷达扫描线",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/radarScanLine.jpg"),
                route: "radarScanLine",
            ...
            },
            {
                label: "动态扫描线",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/dynamicScanCircle.jpg"),
            ...
            },
            {
                label: "扇形扫描圈",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/sectorScan.jpg"),
                route: "sectorScan",
            ...
            },
            {
                label: "雷达扩散圈",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/scanSegment.jpg"),
                route: "scanSegment",
            ...
            },
            {
                label: "双向扩散圈",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/bidirectDiffuseCircle.jpg"),
            ...
            },
            {
                label: "电弧特效",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/electricEllipsoid.jpg"),
            ...
            },
            {
                label: "电光特效",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/electricLightEllipsoid.jpg"),
            ...
            },
            {
                label: "球体特效",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/flowEllipsoid.jpg"),
                route: "flowEllipsoid",
            ...
            },
            {
                label: "渐变填充",
                show: true,
                img: require("@/assets/cover/specialEffectPlot/gradientPolygon.jpg"),
    ...
    },
    {
        ...
        components: [
            ...
            },
            {
                label: "点光源2",
                show: true,
                img: require("@/assets/cover/sceneEffect/pointLightSource2.png"),
                route: "pointLightSource2",
                component: () => import("@/components/example/sceneEffect/PointLightSource2.vue"),
            },
            {
                label: "火焰特效",
                show: true,
